...
{
    /**
     * Referenční slovník klíčů s výchozími českými překlady.
     *
     * @var array
     */
    ...
    /**
     * Získá všechny referenční klíče.
     *
     * @return array Seznam všech klíčů.
     */
    ...
    /**
     * Získá celý referenční slovník.
     *
     * @return array Asociativní pole s klíči a výchozími českými překlady.
     */
    ...
    /**
     * Získá výchozí překlad pro daný klíč.
     *
     * @param string $key Klíč fráze.
     * @return string|null Výchozí překlad nebo null, pokud klíč neexistuje.
     */
