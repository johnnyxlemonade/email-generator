...
{
    /**
     * Ověří, zda je daný objekt platným typem pro kolekci (v tomto případě instancí třídy Product).
     *
     * @param mixed $item Objekt, který se ověřuje.
     * @return bool True, pokud je objekt platný (instancí Product); jinak false.
     */
